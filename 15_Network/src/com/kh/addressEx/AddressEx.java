...
/*
IP 주소 : 컴퓨터에서 네트워크의 특정 장치를 확인하는데 사용하는 숫자

가장 기본 주소 = 192.168.0.1 localhost 127.0.0.1
나중에 내 컴퓨터 실제 주소를 알고 싶다면 검색창에 IP 주소 확인

port = 네트워크에서 데이터를 주고 받을 수 있는 장소 
타인의 컴퓨터나 도메인, 또는 특정 위치에 들어갈 수 있는 번호  2자리  4자리  

InetAddress : Java 에서 IP 주소를 나타내는데 사용
